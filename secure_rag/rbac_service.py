    ...
    def _define_access_rules(self) -> Dict[str, Dict]:
        ...
        return {
            ...
            "security_group_access": {
                ...
                "description": "Access granted via matching Oracle security group",
                "confidence": 0.95
            },
            "owner_access": {
